...
router.delete('/:id', (req, res, next) => {
    ...
    fs_1.default.writeFileSync("./lib/routes/data.json", JSON.stringify(user, null, 4), "utf-8");
...
router.post('/', function (req, res, next) {
    ...
    fs_1.default.writeFile("./lib/routes/data.json", JSON.stringify(fromDataJason, null, " "), (err) => {
        if (err)
            throw err;
        console.log("Saved!");
    });
